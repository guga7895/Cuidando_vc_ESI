...
Então('o ano padrão deve ser o ano atual') do
  ...
  sleep 5
  year_button = find('#app > div > div.c-map.expanded-map > div.map__card-content.container.mx-auto > div > div.bg-white.lg\:pb-8.lg\:p-8.pt-8.pb-3.mb-5.lg\:rounded-lg.lg\:shadow-lg > div:nth-child(2) > div.c-map__year-submit.grid.grid-cols-2.gap-4.h-8 > div:nth-child(1) > div > button')
  ...
  assert_current_path("/"+current_year+'/1')
end